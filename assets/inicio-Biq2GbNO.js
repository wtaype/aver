  ...
  <div class="inicio">
    ...
    <section class="sobre">
      <div class="sobre_contenido">
        ...
        <div class="sobre_imagen">
          <img src="/aver/logo.webp" alt="${o} - Frases Inspiradoras" />
        </div>
      </div>
    </section>
    ...
    <section class="cta_final">
      <div class="cta_contenido">
        ...
        <p class="cta_autor">Creado con ❤️ por <a href="${c}" target="_blank" rel="noopener">${l}</a> • ${n} © ${d()}</p>
      </div>
    </section>
  </div>
`,b=()=>{[".frase_card",".red_card",".sobre_contenido"].forEach(a=>{e(a).each((t,i)=>p(i,()=>e(i).addClass("visible")))}),e(".btn_copiar").on("click",function(a){a.preventDefault();const t=e(this).data("texto");f(t,this,"¡Copiado! ✨")}),e(".btn_compartir").on("click",function(a){a.preventDefault();const i=`${e(this).data("texto")}

✨ ${o} - Frases de Motivación y Fe en Dios
🔗 https://awonbeee.web.app/`;navigator.share?navigator.share({text:i,title:`${o} - Frase Inspiradora`}).catch(()=>{}):window.open(`https://api.whatsapp.com/send?text=${encodeURIComponent(i)}`,"_blank")}),console.log(`✨ ${o} ${n} - Inicio cargado`)},m=()=>{e(".btn_copiar, .btn_compartir").off("click"),console.log("🧹 Inicio limpiado")};export{m as cleanup,b as init,v as render};
