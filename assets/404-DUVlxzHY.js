import{$ as t}from"./main-C-MIaxyj.js";import"./vendor-BwXq8HW-.js";const a=async()=>`
    <div class="wi404">
  ...
  `,o=()=>{t("#wi404-styles").length||t("head").append(`<style id="wi404-styles">
...
@keyframes glitch{0%,100%{transform:translate(0)}25%{transform:translate(-2px,2px)}75%{transform:translate(2px,-2px)}}
    </style>`),t(".wi404_btn").on("click",()=>location.href="/")};export{o as init,a as render};
