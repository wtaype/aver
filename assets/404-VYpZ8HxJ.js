import{$ as t}from"./main-Cwz1NUUS.js";import"./main-CII133VD.js";import"./vendor-BwXq8HW-.js";const o=async()=>`
    <div class="wi404">
  ...
  `,s=()=>{t("#wi404-styles").length||t("head").append(`<style id="wi404-styles">
...
@keyframes glitch{0%,100%{transform:translate(0)}25%{transform:translate(-2px,2px)}75%{transform:translate(2px,-2px)}}
    </style>`),t(".wi404_btn").on("click",()=>location.href="/")};export{s as init,o as render};
